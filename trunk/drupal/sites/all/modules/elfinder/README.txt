...
Installation:
  ...
  5. Go to Administer > Site configuration > Wysiwyg profiles. Click 'edit' near editor profile name. Enable 'elFinder' checkbox under 'Buttons and plugins' section. See attached screenshots.
